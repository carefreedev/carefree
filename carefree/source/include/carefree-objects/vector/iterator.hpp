...
/* managed vector for managed objects - iterator class
 */

#ifndef __CFO_VECTOR_ITERATOR_HPP
#define __CFO_VECTOR_ITERATOR_HPP
...
namespace cfo { namespace intern
{
  ...
  }; /* class basic_manager::vector<>::iterator */
} } /* namespace cfo::intern */

#endif /* __CFO_VECTOR_ITERATOR_HPP */
